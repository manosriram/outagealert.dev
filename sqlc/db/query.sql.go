...
INSERT INTO monitor(name, period, grace_period, user_id, project_id, ping_url, type) VALUES($1, $2, $3, $4, $5, $6, $7) RETURNING id, name, period, grace_period, user_id, project_id, ping_url, status, type, last_ping, created_at, updated_at
`
...
INSERT INTO project(name, user_id) VALUES($1, $2) RETURNING id, name, user_id, created_at, updated_at
`
...
func (q *Queries) CreateProject(ctx context.Context, arg CreateProjectParams) error {
	_, err := q.db.Exec(ctx, createProject, arg.Name, arg.UserID)
	return err
}

const getMonitorById = `-- name: GetMonitorById :one
SELECT id, name, period, grace_period, user_id, project_id, ping_url, status, type, last_ping, created_at, updated_at FROM monitor WHERE id = $1
`
...
SELECT id, name, user_id, created_at, updated_at FROM project WHERE id = $1
`
...
SELECT id, name, period, grace_period, user_id, project_id, ping_url, status, type, last_ping, created_at, updated_at FROM monitor WHERE user_id = $1
`

func (q *Queries) GetUserMonitors(ctx context.Context, userID int32) ([]Monitor, error) {
...
SELECT id, name, user_id, created_at, updated_at FROM project WHERE user_id = $1
`

func (q *Queries) GetUserProjects(ctx context.Context, userID int32) ([]Project, error) {
...
func (q *Queries) UpdateUserMonitorName(ctx context.Context, arg UpdateUserMonitorNameParams) error {
	_, err := q.db.Exec(ctx, updateUserMonitorName, arg.Name, arg.UserID)
	return err
}
...
func (q *Queries) UpdateUserMonitorSchedule(ctx context.Context, arg UpdateUserMonitorScheduleParams) error {
	_, err := q.db.Exec(ctx, updateUserMonitorSchedule, arg.Period, arg.GracePeriod, arg.UserID)
	return err
}
...
func (q *Queries) UpdateUserProjectName(ctx context.Context, arg UpdateUserProjectNameParams) error {
	_, err := q.db.Exec(ctx, updateUserProjectName, arg.Name, arg.UserID)
	return err
}
