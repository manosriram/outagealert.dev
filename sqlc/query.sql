...
INSERT INTO monitor(name, period, grace_period, user_email, project_id, ping_url, type) VALUES($1, $2, $3, $4, $5, $6, $7) RETURNING *;
...
INSERT INTO project(name, user_email, visibility) VALUES($1, $2, $3) RETURNING *;
